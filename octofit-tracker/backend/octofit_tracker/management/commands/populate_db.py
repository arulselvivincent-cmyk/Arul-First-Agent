...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create activities
        Activity.objects.create(user='Iron Man', type='run', duration=30, date='2026-03-16')
        Activity.objects.create(user='Superman', type='swim', duration=45, date='2026-03-16')
        ...
        Workout.objects.create(name='Sprint', description='Run 100 meters as fast as possible', difficulty='medium')
